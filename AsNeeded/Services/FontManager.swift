...
enum FontManager {
    ...
    private static func registerFont(fileName: String, fontFamily _: String) {
        ...
        guard let fontURL = Bundle.main.url(forResource: fileName.replacingOccurrences(of: ".ttf", with: ""), withExtension: "ttf", subdirectory: "Resources/Fonts") ??
            Bundle.main.url(forResource: fileName.replacingOccurrences(of: ".ttf", with: ""), withExtension: "ttf")
        else {
