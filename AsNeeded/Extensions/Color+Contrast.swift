...
extension View {
	...
	func contrastingForeground(
		...
		self.foregroundStyle(backgroundColor.contrastingForegroundColor(for: colorScheme))
	}
	...
	func contrastingSecondaryForeground(
		...
		self.foregroundStyle(backgroundColor.contrastingSecondaryColor(for: colorScheme))
	}
}