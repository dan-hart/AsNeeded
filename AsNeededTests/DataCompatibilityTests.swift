...
@MainActor
@Suite(.tags(.compatibility, .dataManagement, .unit))
struct DataCompatibilityTests {
    ...
    func importOlderVersionFormat() async throws {
    ...
    func importMissingOptionalFields() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportIncludesAllFields() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func importWithUnknownFields() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func importVariousDateFormats() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func largeDatasetHandling() async throws {
        ...
        for i in 1 ... eventCount {
            let event = ANEventConcept(
                eventType: .doseTaken,
                date: Date(timeIntervalSince1970: TimeInterval(1_640_995_200 + i * 3600))
            )
    ...
    func internationalCharacters() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func consistentJSONStructure() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func partialImportFailure() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
