...
struct MedicationHistoryViewModelTests {
	...
	func testUpdateEventIncreaseDoseDecreasesQuantity() async throws {
	...
	func testUpdateEventDecreaseDoseIncreasesQuantity() async throws {
	...
	func testUpdateEventSameDoseKeepsQuantityUnchanged() async throws {
		// Given: medication with quantity 10, event with dose 2
		let medication = createTestMedication(quantity: 10.0)
		let event = createTestEvent(medication: medication, amount: 2.0, unit: .tablet)
	...
	func testUpdateEventChangesDate() async throws {
	...
	func testUpdateEventChangesUnit() async throws {
	...
	func testUpdateEventWithNilQuantity() async throws {
	...
	func testUpdateEventLargeDoseIncrease() async throws {
	...
	func testUpdateEventFractionalDoses() async throws {
