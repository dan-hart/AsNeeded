...
struct FontManagerTests {
	...
	func testSystemFontWithoutRegistration() {
	...
	func testOpenDyslexicAvailability() {
		// Register fonts
		FontManager.registerCustomFonts()
	...
	func testGetAvailableFontInfoReturnsDictionary() {
		FontManager.registerCustomFonts()
	...
	func testFontInfoContainsAtkinsonKey() {
		FontManager.registerCustomFonts()
	...
	func testFontInfoContainsOpenDyslexicKey() {
		FontManager.registerCustomFonts()
	...
	func testFontInfoReturnsArrays() {
		FontManager.registerCustomFonts()
	...
	func testAtkinsonFontInfoStructure() {
		FontManager.registerCustomFonts()
	...
	func testOpenDyslexicFontInfoStructure() {
		FontManager.registerCustomFonts()
	...
	func testAtkinsonRegularFontName() {
		FontManager.registerCustomFonts()
	...
	func testCustomFontAvailabilityConsistency() {
		FontManager.registerCustomFonts()
	...
	func testRegistrationBeforeCheck() {
		// Register first
		FontManager.registerCustomFonts()
	...
	func testFontInfoWithoutRegistration() {
	...
	func testConcurrentFontChecks() async {
		FontManager.registerCustomFonts()

		await withTaskGroup(of: Bool.self) { group in
			for _ in 0..<10 {
				group.addTask {
					return FontManager.isFontAvailable(.atkinsonHyperlegible)
				}
				group.addTask {
					return FontManager.isFontAvailable(.system)
				}
			}
	...
	func testFontAvailabilityStable() {
		FontManager.registerCustomFonts()
	...
	func testFontAvailabilityPerformance() {
		FontManager.registerCustomFonts()
