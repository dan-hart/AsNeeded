...
struct MedicationNameParserTests {
    ...
    @available(iOS 26.0, *)
    func componentsDosageIncomplete() {
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsBrandNameBrackets() async throws {
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsBrandNameParentheses() async throws {
        let parser = MedicationNameParser.shared
        let components = try await parser.parseComponents(from: "Ibuprofen (Advil) 200mg")
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsDosage() async throws {
        let parser = MedicationNameParser.shared
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsReleaseType() async throws {
        let parser = MedicationNameParser.shared
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsRoute() async throws {
        let parser = MedicationNameParser.shared
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComponentsForm() async throws {
        let parser = MedicationNameParser.shared
    ...
    @available(iOS 26.0, *)
    @MainActor
    func extractBrandNameNil() async throws {
        let parser = MedicationNameParser.shared
    ...
    @MainActor
    func simplifierEnhancedFallback() async {
    ...
    @MainActor
    func simplifierEnhancedBrandFallback() async {
    ...
    @available(iOS 26.0, *)
    @MainActor
    func parseComplexNames() async throws {
        let parser = MedicationNameParser.shared
