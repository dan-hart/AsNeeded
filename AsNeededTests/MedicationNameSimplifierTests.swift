...
struct MedicationNameSimplifierTests {
	...
	@Test
	func testDeduplicateResultsRemovesDuplicateSimplifiedNames() {
	...
	@Test
	func testDeduplicateResultsKeepsHighestScoredResult() {
	...
	@Test
	func testDeduplicateResultsPreservesDifferentMedications() {
	...
	@Test
	func testDeduplicateResultsHandlesEmptyArray() {
	...
	@Test
	func testDeduplicateResultsSortsByScore() {
	...
	@Test
	func testProcessSearchResultsSimplariesNames() {
