...
struct MedicationTrendsViewModelTests {
	...
	func testInitializationWithMedications() async throws {
	...
	func testInitializationWithSpecificID() async throws {
	...
	func testEnsureValidSelectionNoneSelected() async throws {
	...
	func testEnsureValidSelectionKeepsValid() async throws {
	...
	func testEnsureValidSelectionInvalidToFirst() async throws {
	...
	func testEventsFilteredByMedicationID() async throws {
	...
	func testEventsFilteredByDoseTakenType() async throws {
	...
	func testEventsSortedByDate() async throws {
	...
	func testPreferredUnitFromPrescribed() async throws {
	...
	func testPreferredUnitFromEvent() async throws {
	...
	func testPreferredUnitNil() async throws {
	...
	func testDailyTotalsSingleDay() async throws {
	...
	func testDailyTotalsIncludesZeroDays() async throws {
	...
	func testDailyTotals14Days() async throws {
	...
	func testDailyTotalsMatchingUnitsOnly() async throws {
	...
	func testAveragePerDayNoEvents() async throws {
	...
	func testAveragePerDayPartialWindow() async throws {
	...
	func testDaysUntilRefillNil() async throws {
	...
	func testDaysUntilRefillToday() async throws {
	...
	func testEstimatedDaysRemainingZeroQuantity() async throws {
	...
	func testEstimatedDaysRemainingZeroAverage() async throws {
	...
	func testUsagePercentageNoInitial() async throws {
	...
	func testUsagePercentageCapped() async throws {
	...
	func testRefillCycleStatusOnTrack() async throws {
	...
	func testRefillCycleStatusAhead() async throws {
	...
	func testRefillCycleStatusBehind() async throws {
	...
	func testRefillCycleStatusUnknown() async throws {
	...
	func testCalendarHeatmapDataCount() async throws {
	...
	func testCalendarHeatmapDataZeroDays() async throws {
	...
	func testCalendarHeatmapDataIntensity() async throws {
	...
	func testCalendarHeatmapDataAggregation() async throws {
