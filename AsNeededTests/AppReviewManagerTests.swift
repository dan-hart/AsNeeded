...
struct AppReviewManagerTests {
	...
	func testResetPreferencesClearsOptOut() {
		let manager = createTestManager()
	...
	func testManualReviewBypassesOptOut() {
		let manager = createTestManager()
	...
	func testManualReviewWhenNotOptedOut() {
		let manager = createTestManager()
	...
	func testConsecutiveDaysInitial() {
		let manager = createTestManager()
	...
	func testEngagementPersistsAcrossOptOut() {
		let manager = createTestManager()
	...
	func testReviewServiceCTAVisibility() {
		let reviewService = ReviewService.shared
