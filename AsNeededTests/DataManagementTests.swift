...
struct DataManagementTests {
    ...
    func createTestMedication(id: UUID = UUID()) -> ANMedicationConcept {
        return ANMedicationConcept(
            ...
            lastRefillDate: Date(timeIntervalSince1970: 1_640_995_200), // 2022-01-01
            nextRefillDate: Date(timeIntervalSince1970: 1_643_673_600), // 2022-02-01
    ...
    func createTestEvent(id: UUID = UUID(), medicationId: UUID = UUID()) -> ANEventConcept {
        ...
        return ANEventConcept(
            ...
            dose: dose,
            date: Date(timeIntervalSince1970: 1_640_995_200) // 2022-01-01
        )
    }
    ...
    func exportEmptyDataStore() async throws {
    ...
    func exportWithMedications() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportWithEvents() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportDateFormat() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func importClearsExistingData() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func importIncompletJSON() async throws {
        let dataStore = createTestDataStore()
    ...
    func roundTripDataIntegrity() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportWithRedaction() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
        ...
        guard let events = redactedJSON?["events"] as? [[String: Any]],
              let exportedEvent = events.first,
              let eventMedication = exportedEvent["medication"] as? [String: Any]
        else {
    ...
    func exportWithoutRedaction() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportWithSpecialCharacters() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func exportWithNilValues() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
    ...
    func comprehensiveDataExportImportIntegrity() async throws {
        let dataStore = createTestDataStore()
        try await dataStore.clearAllData()
        ...
        let med2 = ANMedicationConcept(
            ...
            lastRefillDate: Date(timeIntervalSince1970: 1_641_081_600),
        ...
        let med5 = ANMedicationConcept(
            ...
            lastRefillDate: Date(timeIntervalSince1970: 1_642_291_200),
            nextRefillDate: Date(timeIntervalSince1970: 1_644_883_200),
            prescribedUnit: ANUnitConcept.milligram,
        ...
        let med7 = ANMedicationConcept(
            ...
            initialQuantity: 30.0,
            lastRefillDate: nil,
            nextRefillDate: Date(timeIntervalSince1970: 1_650_000_000),
            prescribedUnit: ANUnitConcept.milligram,
        ...
        let med9 = ANMedicationConcept(
            ...
            lastRefillDate: Date(timeIntervalSince1970: 1_700_000_000),
            nextRefillDate: Date(timeIntervalSince1970: 1_705_000_000),
            prescribedUnit: ANUnitConcept.milligram,
        ...
        let med10 = ANMedicationConcept(
            ...
            lastRefillDate: Date(timeIntervalSince1970: 1_600_000_000),
            nextRefillDate: Date(timeIntervalSince1970: 1_605_000_000),
            prescribedUnit: ANUnitConcept.milligram,
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_000_000),
        ...
        allEvents.append(ANEventConcept(
            ...
            medication: med1,
            dose: ANDoseConcept(amount: 500.0, unit: ANUnitConcept.milligram),
            date: Date(timeIntervalSince1970: 1_641_086_400),
            note: nil // No note
        ))
        ...
        allEvents.append(ANEventConcept(
            ...
            medication: med1,
            dose: nil,
            date: Date(timeIntervalSince1970: 1_641_172_800),
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_100_000),
        ...
        allEvents.append(ANEventConcept(
            ...
            medication: med2,
            dose: ANDoseConcept(amount: 200.0, unit: ANUnitConcept.milligram),
            date: Date(timeIntervalSince1970: 1_641_200_000),
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_300_000),
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_400_000),
            note: nil
        ))
        ...
        for i in 1 ... 5 {
            allEvents.append(ANEventConcept(
                ...
                date: Date(timeIntervalSince1970: 1_642_291_200 + TimeInterval(i * 86400)),
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_500_000),
            note: nil
        ))
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_600_000),
            note: "Low dose test"
        ))
        ...
        allEvents.append(ANEventConcept(
            ...
            medication: med7,
            dose: nil,
            date: Date(timeIntervalSince1970: 1_641_700_000),
            note: nil
        ))
        ...
        allEvents.append(ANEventConcept(
            ...
            date: Date(timeIntervalSince1970: 1_641_800_000),
        ...
        allEvents.append(ANEventConcept(
            ...
            medication: med8,
            dose: ANDoseConcept(amount: 1000.0, unit: ANUnitConcept.milligram),
            date: Date(timeIntervalSince1970: 1_641_900_000),
            note: nil
        ))
        ...
        for i in 1 ... 3 {
            allEvents.append(ANEventConcept(
                ...
                date: Date(timeIntervalSince1970: 1_700_000_000 + TimeInterval(i * 3600)),
        ...
        for i in 1 ... 3 {
            allEvents.append(ANEventConcept(
                ...
                date: Date(timeIntervalSince1970: 1_600_000_000 + TimeInterval(i * 3600)),
