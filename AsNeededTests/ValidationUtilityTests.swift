...
struct ValidationUtilityTests {
	...
	func testMedicationNameTrimming() {
	...
	func testMedicationEmptyClinicalName() {
		let medication = ANMedicationConcept(
			clinicalName: "",
	...
	func testMedicationInvalidDose() {
	...
	func testMedicationLongNickname() {
		let medication = ANMedicationConcept(
	...
	func testEventMissingMedication() {
		let dose = ANDoseConcept(amount: 10, unit: .milligram)
		let event = ANEventConcept(
			eventType: .doseTaken,
			medication: nil,
	...
	func testBulkMedicationValidation() {
	...
	func testFindDuplicateMedicationsByNickname() {
