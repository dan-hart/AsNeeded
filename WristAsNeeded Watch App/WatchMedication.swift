...
struct WatchMedication: Identifiable, Codable {
    ...
    init(from dict: [String: Any]) {
        ...
        self.displayName = dict["displayName"] as? String ?? "Unknown"
        self.quantity = dict["quantity"] as? Double ?? 0.0
        self.prescribedDoseAmount = dict["prescribedDoseAmount"] as? Double
        self.prescribedUnit = dict["prescribedUnit"] as? String
    }
}
